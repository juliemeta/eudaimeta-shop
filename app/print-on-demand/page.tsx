      ...
      <StyledContainer>
        <StyledTextWrapper>
          ...
          <Typography>
            ...
            inden for fast fashion. Hver sæson produceres enorme mængder tøj,
            som aldrig bliver solgt. Nyt og ubrugt tøj, som intet fejler, ender
            i værste fald med at blive destrueret. Det handler ikke kun om
            manglende efterspørgsel men også om logistik og økonomi. Tøj, der
            ikke bliver solgt i tide, optager lagerplads og binder værdi. Et
            klassisk eksempel er sommertøj, der ikke bliver udsolgt. Når sæsonen
            skifter, skal det opbevares, hvilket skaber flaskehalse i lageret og
            forstyrrer flowet. Resultatet? Overproduktion og i nogle tilfælde
            destruktion af helt nye varer.
          </Typography>
          <br />
          ...
          <Typography>
            ...
            produktion i Europa, hvilket også hjælper med at reducere
            transportafstande.
          </Typography>
          <br />
          <Typography variant="h2">Mindre spild, mere mening </Typography>
          <Typography>
            Når du køber hos os, bliver det produkt du køber i vores webshop
            lavet specielt til dig. En t-shirt ligger klar i sin grundform, men
            designet trykkes først på t-shirten, når du køber varen. Det
            betyder:
            <List>
          ...
          <Typography>
            Vi bestræber os på at reducere brugen af plastic i vores emballage.
            Vi er ikke i mål endnu, men vi forbedrer løbende vores løsninger.
            ...
            være nervøs for, at den ting du har forelsket dig i, bliver
            billigere i morgen eller om en måned.
          </Typography>
        </StyledTextWrapper>
